...
# This function is to extract mag or maglef to spice calling extract_mag.tcl script
# arguments to the function:
#               ext_file   --> mag file absolute path to get extracted
#               output_dir --> output directory
# output of the function:
#               creates a tmp_ext directory under the output directory and dumps the .ext files there
#               generates the .spice netlist under the output directory
...
# This function is to run LVS on extracted spice, and verilog GL netlist
# arguments to the function:
#               netlist_1  --> spice netlist
#               netlist_2  --> verilog GL netlist
#               output_dir --> output directory
#               lvs_type   --> tyoe of lvs done: gds or mag
# output of the function:
